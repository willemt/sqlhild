...
class MySqlParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MySqlParser#andLogicalOperator.
    def enterAndLogicalOperator(self, ctx:MySqlParser.AndLogicalOperatorContext):
        pass

    # Exit a parse tree produced by MySqlParser#andLogicalOperator.
    def exitAndLogicalOperator(self, ctx:MySqlParser.AndLogicalOperatorContext):
        pass


    # Enter a parse tree produced by MySqlParser#orLogicalOperator.
    def enterOrLogicalOperator(self, ctx:MySqlParser.OrLogicalOperatorContext):
        pass

    # Exit a parse tree produced by MySqlParser#orLogicalOperator.
    def exitOrLogicalOperator(self, ctx:MySqlParser.OrLogicalOperatorContext):
        pass
